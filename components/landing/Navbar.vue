  ...
  <LandingContainer>
    <header class="flex flex-col lg:flex-row justify-between items-center my-5">
      <div class="flex w-full lg:w-auto items-center justify-between">
        <a href="/" class="text-lg"><span class="font-bold text-slate-800 dark:text-neutral-200">Sistem</span><span class="text-slate-500 dark:text-neutral-400">pakar</span> </a>
      ...
      <nav class="w-full lg:w-auto mt-2 lg:flex lg:mt-0" :class="{ block: open, hidden: !open }">
        <ul class="flex flex-col lg:flex-row lg:gap-3">
          <li v-for="item of menuitems">
            <a :href="item.path" class="flex lg:px-3 py-2 text-gray-600 hover:text-gray-900 dark:text-neutral-400 hover:dark:text-neutral-200">
              {{ item.title }}
            </a>
          </li>
        </ul>
        <div class="lg:hidden flex items-center mt-3 gap-4">
          <LandingLink href="/signin" styleName="muted" block size="md">Sign in</LandingLink>
